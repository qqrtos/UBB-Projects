...
void Service::addSongToRepository(const std::string& artist, const std::string& title, double minutes, double seconds, const std::string& source)
{
	...
	this->undoRedoController.addUndoAction(new ActionRemove(this->repo, s));
	this->undoRedoController.addRedoAction(new ActionAdd(this->repo, s));
}
...
void Service::removeSongFromRepository(const std::string & artist, const std::string & title)
{
	...
	this->undoRedoController.addRedoAction(new ActionRemove(this->repo, s));
	this->undoRedoController.addUndoAction(new ActionAdd(this->repo, s));
}
