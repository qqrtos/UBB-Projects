...
public:
	Service(const Repository& r, FilePlaylist* p, SongValidator v, UndoRedoController& undoRedoController) : repo{ r }, playList{ p }, validator{ v }, undoRedoController{ undoRedoController } {}
